...
ggplot(data = dc_seasonal_weather_1980s, aes(year,wt03_Winter)) + geom_point() + geom_smooth(method = "lm")
ggplot(data = dc_seasonal_weather_1980s, aes(year,wt03_Summer)) + geom_point() + geom_smooth(method = "lm")
ggplot(data = dc_seasonal_weather_1980s, aes(year,mdpr_Fall)) + geom_point() + geom_smooth(method = "lm")
ggplot(data = dc_seasonal_weather_1980s, aes(year,dapr_Spring)) + geom_point() + geom_smooth(method = "lm")
ggplot(data = dc_seasonal_weather_1980s, aes(year,dapr_Fall)) + geom_point() + geom_smooth(method = "lm")
ggplot(data = dc_seasonal_weather_1980s, aes(year,tobs_Spring)) + geom_point() + geom_smooth(method = "lm")
ggplot(data = dc_seasonal_weather_1980s, aes(year,prcp_Fall)) + geom_point() + geom_smooth(method = "lm")
ggplot(data = dc_seasonal_weather_1980s, aes(year,tmax_Spring)) + geom_point() + geom_smooth(method = "lm")
ggplot(data = dc_seasonal_weather_1980s, aes(year,tmin_Fall)) + geom_point() + geom_smooth(method = "lm")
ggplot(data = dc_seasonal_weather_1980s, aes(year,tmin_Summer)) + geom_point() + geom_smooth(method = "lm")
